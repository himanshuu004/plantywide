...
const ScubsCard = () => {
  return (
    <div className="w-full max-w-[960px] flex flex-col justify-start items-start py-20 gap-8">
      <div className="w-full flex justify-start items-center text-3xl md:text-5xl px-8 md:px-0 font-medium">
        Choose Your Plant Subscription
      </div>
      <div className="w-full flex flex-col md:flex-row justify-between items-start gap-6 px-8 md:px-0">
        <div className="w-full md:w-1/3 min-h-full flex flex-col justify-start items-start gap-2 font-light text-[#dfdfdf] py-4 hover:border-y-2 hover:hover-[#dfdfdf] duration-75 ease-in ">
